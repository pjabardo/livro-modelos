...
\subsection{Grandezas com dimensões independentes}

Tendo estabelecido uma classe de unidades, as grandezas que caracterizam o problema são $X_1$, $X_2$, \ldots, $X_N$.
