...
O perímetro do floco de Koch lembra bastante a superfície rugosa de um sólido. Caso algum fenômeno dependa apenas da área, $N$ não precisa ser muito grande para que uma análise seja precisa mas se depender do perímetro, as coisas podem se complicar e algum cuidado é necessário. Mas como resultado do simples fato de falarmos em rugosidade implica em que alguma simplificação pode ser feita. Alguns exemplos serão analisados com alguma profundidade mais para frente.
